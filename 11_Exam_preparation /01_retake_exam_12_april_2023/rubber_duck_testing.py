...
# initialising the inputs : 1st one is a deque of the programmers time needed second one is the tasks needed to be done
programmers = deque(map(int, input().split()))
tasks = list(map(int, input().split()))

# the reward given are kept in a list
givenDucks = {
    "Darth Vader Ducky": 0,
    "Thor Ducky": 0,
